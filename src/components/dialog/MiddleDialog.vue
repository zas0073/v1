<template>
  <v-dialog v-model="isActive" max-width="600">
    <template v-slot:activator="{ props: activatorProps }">
      <v-btn v-bind="activatorProps" text="Open Dialog(600*540)"></v-btn>
    </template>

    <template v-slot:default>
      <v-card title="600*540 다이얼로그" max-height="540">
        ...
        <div class="pa-4 text-end border-t">
          <v-spacer></v-spacer>

          <v-btn text="취소" @click="closeDialog" variant="outlined"></v-btn>
